...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser,
                NAME_DESC_AMY + PHONE_DESC_AMY + EMAIL_DESC_AMY + ADDRESS_DESC_AMY
                        + TELEGRAM_DESC_AMY + GITHUB_DESC_AMY + TAG_DESC_FRIEND,
    ...
    public void parse_repeatedNonTagValue_failure() {
        String validExpectedPersonString = NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + TELEGRAM_DESC_BOB + GITHUB_DESC_BOB + TAG_DESC_FRIEND;
    ...
    public void parse_invalidTelegram_failure() {
        assertParseFailure(parser,
                NAME_DESC_AMY + PHONE_DESC_AMY + EMAIL_DESC_AMY + ADDRESS_DESC_AMY
                        + INVALID_TELEGRAM_DESC + GITHUB_DESC_AMY + TAG_DESC_FRIEND,
    ...
    public void parse_invalidGitHub_failure() {
        assertParseFailure(parser,
                NAME_DESC_AMY + PHONE_DESC_AMY + EMAIL_DESC_AMY + ADDRESS_DESC_AMY
                        + TELEGRAM_DESC_AMY + INVALID_GITHUB_DESC + TAG_DESC_FRIEND,
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + TELEGRAM_DESC_BOB + GITHUB_DESC_BOB + INVALID_TAG_DESC + VALID_TAG_FRIEND,
        ...
        assertParseFailure(parser, PREAMBLE_NON_EMPTY + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + TELEGRAM_DESC_BOB + GITHUB_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND,
